		...
		<div class="card">
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Sign Up</button>
				</div>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="SignUp" method="post">
    <div class="container">
      ...
      <label for="userPhoneNumber"><b>phone number</b></label>
